{* 
 * steim_pasm3 - compression/decompression code with logging code added.
 *}
...
PUB GETLOGLEN
'' return populated length of log
  return logIdx
...
:loopns
  ...
  ' If this is the last iteration, DON'T WRITE/INCREMENT comprcode
  ' ccomprcode is written again in :done... so it
  ' would be written twice...
  cmp _cns, #1 wz
  if_z jmp #:samelong

  mov _clogVal, _cns '_ccomprcodebufptr
  call #LOG
